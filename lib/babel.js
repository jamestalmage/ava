'use strict';
var assertSupport = require('./assert-support');
var defaultAssertPlugin = require('./default-assert-plugin');
var shared = require('./shared');
shared.assert = assertSupport([defaultAssertPlugin]);
...
var powerAssert = createEspowerPlugin(babel, {
	patterns: shared.assert.patterns
});
